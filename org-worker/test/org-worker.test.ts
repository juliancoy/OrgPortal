  ...
  async run(sql: string, params: unknown[]) {
    ...
    if (sql.includes("INSERT INTO events")) {
      const row: Row = {
        ...
        social_title: params[11],
        social_description: params[12],
        social_image_url: params[13],
        host_user_id: params[14],
        host_user_name: params[15],
        host_org_id: params[16],
        host_org_name: params[17],
        host_org_source_url: params[18],
        event_chat_room_id: params[19],
        event_chat_room_alias: params[20],
        event_chat_room_name: params[21],
        tags: params[22],
        city: params[23],
        created_at: params[24] || now,
        updated_at: params[25] || now,
      };
