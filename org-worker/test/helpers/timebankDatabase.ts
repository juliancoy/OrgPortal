...
export class TimebankDatabase {
  ...
  constructor() {
    ...
    this.sqlite.exec(readFileSync(new URL('../../migrations/0017_timebank.sql', import.meta.url), 'utf8'));
    this.sqlite.exec(readFileSync(new URL('../../migrations/0018_timebank_communities_images.sql', import.meta.url), 'utf8'));
    this.sqlite.exec(readFileSync(new URL('../../migrations/0019_timebank_uptake.sql', import.meta.url), 'utf8'));
    this.sqlite.exec(readFileSync(new URL('../../migrations/0020_timebank_notifications.sql', import.meta.url), 'utf8'));
    this.sqlite.exec(readFileSync(new URL('../../migrations/0021_timebank_listing_visibility.sql', import.meta.url), 'utf8'));
  }
