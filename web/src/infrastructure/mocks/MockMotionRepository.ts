...
function seed(): Motion[] {
  ...
  const motions: Motion[] = [
    ...
    },
    {
      ...
      proposerUserName: 'Carol Davis',
      proposerOrgId: 'org_seed_code_collective',
...
export class MockMotionRepository implements MotionRepository {
  ...
  async create(input: CreateMotionInput): Promise<Motion> {
    ...
    const motion: Motion = {
      ...
      status: 'proposed',
      proposerType: input.proposerType || 'user',
      proposerId: input.proposerId,
      proposerName: input.proposerName,
      proposerUserName: input.proposerUserName,
      proposerOrgId: input.proposerOrgId,
      proposerOrgName: input.proposerOrgName,
      createdAtISO: now,
      updatedAtISO: now,
