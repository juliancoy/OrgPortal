...
import { isAndroidDevice, resolveAndroidApkUrl } from '../../infrastructure/platform/androidApp'
    ...
    <header className="portal-header">
      ...
      <div className="portal-nav-bar">
        <div className="portal-nav">
          ...
          {showAndroidDownload ? (
            <a href={androidApkUrl} className="portal-nav-link" target="_blank" rel="noreferrer">
              <svg width="18" height="18" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
